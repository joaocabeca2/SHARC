    ...
    def __init__(self):
        ...
        self.p676_a = np.array(
            [[0.975, 9.651, 6.690, 0.0, 2.566, 6.850], [2.529, 8.653, 7.170, 0.0, 2.246, 6.800],
             ...
             [945.300, 2.109, 11.340, 0.0, -1.172, 6.135], [543.400,
                                                            0.014, 17.030, 0.0, 3.525, -0.978],
             [1331.800, 1.654, 11.890, 0.0, -2.378, 6.547], [1746.600,
                                                             1.255, 12.230, 0.0, -3.545, 6.451],
             [2120.100, 0.910, 12.620, 0.0, -5.416, 6.056], [2363.700,
                                                             0.621, 12.950, 0.0, -1.932, 0.436],
             [1442.100, 0.083, 14.910, 0.0, 6.768,
                 - 1.273], [2379.900, 0.387, 13.530, 0.0, -6.561, 2.309],
             [2090.700, 0.207, 14.080, 0.0, 6.957,
                 - 0.776], [2103.400, 0.207, 14.150, 0.0, -6.395, 0.699],
             [2438.000, 0.386, 13.390, 0.0, 6.342,
                 - 2.825], [2479.500, 0.621, 12.920, 0.0, 1.014, -0.584],
             [2275.900, 0.910, 12.630, 0.0, 5.014,
                 - 6.619], [1915.400, 1.255, 12.170, 0.0, 3.029, -6.759],
             [1503.000, 0.083, 15.130, 0.0, -4.499, 0.844], [1490.200,
                                                             1.654, 11.740, 0.0, 1.856, -6.675],
             [1078.000, 2.108, 11.340, 0.0, 0.658, -6.139], [728.700,
                                                             2.617, 10.880, 0.0, -3.036, -2.895],
             [461.300, 3.181, 10.380, 0.0, -3.968,
                 - 2.590], [274.000, 3.800, 9.960, 0.0, -3.528, -3.680],
             [153.000, 4.473, 9.550, 0.0, -2.548, -5.002], [80.400,
                                                            5.200, 9.060, 0.0, -1.660, -6.091],
             [39.800, 5.982, 8.580, 0.0, -1.680, -6.393], [18.560,
                                                           6.818, 8.110, 0.0, -1.956, -6.475],
             [8.172, 7.708, 7.640, 0.0, -2.216, -6.545], [3.397,
                                                          8.652, 7.170, 0.0, -2.492, -6.600],
             [1.334, 9.650, 6.690, 0.0, -2.773, -6.650], [940.300,
        ...
        self.p676_b = np.array(
            [[.1079, 2.144, 26.38, .76, 5.087, 1.00], [.0011, 8.732, 28.58, .69, 4.930, .82],
             ...
             [.0045, 7.347, 21.52, .63, 4.810, .55], [.0632,
                                                      5.048, 18.45, .60, 4.230, .48],
             [.9098, 3.595, 20.07, .63, 4.483, .52], [.1920,
                                                      5.048, 15.55, .60, 5.083, .50],
             [10.41, 1.405, 25.64, .66, 5.028, .67], [.3254,
                                                      3.597, 21.34, .66, 4.506, .65],
             [1.260, 2.379, 23.20, .65, 4.804, .64], [.2529,
                                                      2.852, 25.86, .69, 5.201, .72],
             [.0372, 6.731, 16.12, .61, 3.980, .43], [.0124,
                                                      6.731, 16.12, .61, 4.010, .45],
             [.9785, .158, 26.00, .70, 4.500,
                 1.00], [.1840, .158, 26.00, .70, 4.500, 1.00],
             [497.0, .159, 30.86, .69, 4.552, 1.00], [
                 5.015, 2.391, 24.38, .71, 4.856, .68],
             [.0067, 8.633, 18.00, .60, 4.000, .50], [.2732,
                                                      7.816, 32.10, .69, 4.140, 1.00],
             [243.4, .396, 30.86, .68, 4.352, .84], [.0134,
                                                     8.177, 15.90, .33, 5.760, .45],
             [.1325, 8.055, 30.60, .68, 4.090, .84], [.0547,
                                                      7.914, 29.85, .68, 4.530, .90],
             [.0386, 8.429, 28.65, .70, 5.100, .95], [.1836,
                                                      5.110, 24.08, .70, 4.700, .53],
             [8.400, 1.441, 26.73, .70, 5.150, .78], [.0079,
    ...
    def get_reference_atmosphere_p835(latitude, altitude=1000, season="summer"):
        ...
        if latitude <= 22:
            ...
            if h_km < 10.:
                ...
                p72 = (1012.0306 - 109.0338 * 10 + 3.6316 *
                       10 ** 2) * np.exp(-.147 * (72 - 10))
            ...
            if season == "summer":
                ...
                if h_km <= 10:
                    ...
                    p72 = (1012.8186 - 111.5569 * 10 + 3.8646 *
                           10 ** 2) * np.exp(-.147 * (72 - 10))
                    pressure_hPa = p72 * np.exp(-.165 * (h_km - 72))
                else:
                    error_message = "altitude > 100km not supported"
                ...
                if h_km <= 10:
                    ...
                    p72 = (1018.8627 - 124.2954 * 10 + 4.8307 *
                           10 ** 2) * np.exp(-.147 * (72 - 10))
            ...
            if season == "summer":
                ...
                if h_km <= 10:
                    ...
                    p72 = (1008.0278 - 113.2494 * 10 + 3.9408 *
                           (10 ** 2)) * np.exp(-.140 * (72 - 10))
                    pressure_hPa = p72 * np.exp(-.165 * (h_km - 72))
                else:
                    error_message = "altitude > 100km not supported"
                    raise ValueError(error_message)
                ...
                if h_km <= 10:
                    ...
                    p72 = (1010.8828 - 122.2411 * 10 + 4.554 *
                           10 ** 2) * np.exp(-.147 * (72 - 10))
