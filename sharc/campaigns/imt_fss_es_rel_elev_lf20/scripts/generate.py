...
input_file = base_dir / "imt_fss_es_rel_elev_lf20/scripts/base.yaml"
output_dir = base_dir / "imt_fss_es_rel_elev_lf20/input/"
...
for elev in [3, 10, 30, 60]:
    for link_type in ["dl", "ul"]:
        ...
        modified_text[23] = f"    output_dir: campaigns/imt_fss_es_rel_elev_lf20/output\n"
        ...
        output_filename = f"parameters_imt_macro_fss_es_{link_type}_lf20_elev{elev}deg.yaml"
