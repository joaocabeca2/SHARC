...
input_file = base_dir / "imt_fss_es_rel_dist_borda_lf50/scripts/base.yaml"
output_dir = base_dir / "imt_fss_es_rel_dist_borda_lf50/input/"
...
for dist_borda in [500, 1000, 2000]:
    for link_type in ["dl", "ul"]:
        ...
        modified_text[23] = f"    output_dir: campaigns/imt_fss_es_rel_dist_borda_lf50/output\n"
        ...
        output_filename = f"parameters_imt_macro_fss_es_{link_type}_lf50_dist_borda{x}.yaml"
