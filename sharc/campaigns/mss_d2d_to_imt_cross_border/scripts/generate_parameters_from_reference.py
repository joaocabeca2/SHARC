...
ul_parameter_file_name = os.path.join(input_dir, "./parameters_mss_d2d_to_imt_cross_border_base_ul.yaml")
dl_parameter_file_name = os.path.join(input_dir, "./parameters_mss_d2d_to_imt_cross_border_base_dl.yaml")
...
for link in ["ul", "dl"]:
    ...
    specific = f"activate_random_beam_5p_{link}"
    ...
    specific = f"activate_random_beam_30p_{link}"
    parameters['general']['output_dir_prefix'] = output_prefix_pattern.replace("<specific>", specific)
    ...
    specific = f"random_pointing_1beam_{link}"
    parameters['general']['output_dir_prefix'] = output_prefix_pattern.replace("<specific>", specific)
