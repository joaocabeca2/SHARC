...
input_file = base_dir / "imt_fss_es_rel_azim_lf20/scripts/base.yaml"
output_dir = base_dir / "imt_fss_es_rel_azim_lf20/input/"
...
for azimute in [170, 175, 180]:
    for link_type in ["dl", "ul"]:
        ...
        modified_text[23] = f"    output_dir: campaigns/imt_fss_es_rel_azim_lf20/output\n"
        ...
        output_filename = f"parameters_imt_macro_fss_es_{link_type}_lf20_azim{azimute}deg.yaml"
