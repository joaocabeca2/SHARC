...
imt_dl_inr = post_processor.get_plot_by_results_attribute_name(
...
imt_ul_inr = post_processor.get_plot_by_results_attribute_name(
    "imt_ul_inr", plot_type="ccdf")
...
file = os.path.join(
    campaign_base_dir,
    "output",
    "sys_to_imt_coupling_loss.html")
imt_system_path_loss = post_processor.get_plot_by_results_attribute_name(
    "imt_system_path_loss")
imt_system_path_loss.write_html(
    file=file,
    include_plotlyjs="cdn",
    auto_open=auto_open)
