...
input_file = base_dir / "imt_fss_es_rel_azim_lf50/scripts/base.yaml"
output_dir = base_dir / "imt_fss_es_rel_azim_lf50/input/"
...
for azimute in [170, 175, 180]:
    for link_type in ["dl", "ul"]:
        ...
        modified_text[23] = f"    output_dir: campaigns/imt_fss_es_rel_azim_lf50/output\n"
        modified_text[24] = f"    output_dir_prefix: output_imt_fss_es_{link_type}_azim{azimute}deg\n"
        

        modified_text[152] = f"      fixed: {azimute}\n"
        ...
        output_filename = f"parameters_imt_macro_fss_es_{link_type}_lf50_azim{azimute}deg.yaml"
