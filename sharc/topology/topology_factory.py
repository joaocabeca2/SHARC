...
class TopologyFactory(object):
    ...
    def createTopology(parameters: Parameters) -> Topology:
        if parameters.imt.topology == "SINGLE_BS":
            ...
            return TopologyNTN(
                parameters.ntn.intersite_distance,
                parameters.ntn.cell_radius,
                parameters.ntn.bs_height,
                parameters.ntn.bs_azimuth,
                parameters.ntn.bs_elevation,
                parameters.ntn.num_sectors,
            )
        else:
