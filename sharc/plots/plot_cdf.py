...
def plot_cdf(base_dir, file_prefix, passo_xticks=5, xaxis_title='Value', legends=None, subfolders=None, save_file=True,
             show_plot=False):
    ...
    csv_folder = os.path.abspath(os.path.join(
        workfolder, '..', "campaigns", base_dir, "output"))
    figs_folder = os.path.abspath(os.path.join(
    ...
    if subfolders:
        subdirs = [os.path.join(csv_folder, d) for d in subfolders if os.path.isdir(
    ...
    for idx, subdir in enumerate(subdirs):
        ...
        legenda = legends[idx] if legends else os.path.basename(
            subdir).split(f"output_{base_dir}_")[1]
...
def plot_bs_antenna_gain_towards_the_ue(base_dir, passo_xticks=5, legends=None, subfolders=None, save_file=True,
                                        show_plot=True):
    plot_cdf(base_dir, 'IMT_CDF_of_BS_antenna_gain_towards_the_UE', passo_xticks, xaxis_title='Antenna Gain (dB)',
...
def plot_coupling_loss(base_dir, passo_xticks=5, legends=None, subfolders=None, save_file=True, show_plot=True):
    plot_cdf(base_dir, 'IMT_CDF_of_coupling_loss', passo_xticks, xaxis_title='Coupling Loss (dB)',
             legends=legends, subfolders=subfolders, save_file=save_file, show_plot=show_plot)


def plot_dl_sinr(base_dir, passo_xticks=5, legends=None, subfolders=None, save_file=True, show_plot=True):
    plot_cdf(base_dir, 'IMT_CDF_of_DL_SINR', passo_xticks, xaxis_title='DL SINR (dB)',
             legends=legends, subfolders=subfolders, save_file=save_file, show_plot=show_plot)


def plot_dl_snr(base_dir, passo_xticks=5, legends=None, subfolders=None, save_file=True, show_plot=True):
    plot_cdf(base_dir, 'IMT_CDF_of_DL_SNR', passo_xticks, xaxis_title='DL SNR (dB)',
             legends=legends, subfolders=subfolders, save_file=save_file, show_plot=show_plot)


def plot_dl_throughput(base_dir, passo_xticks=5, legends=None, subfolders=None, save_file=True, show_plot=True):
    plot_cdf(base_dir, 'IMT_CDF_of_DL_throughput', passo_xticks, xaxis_title='DL Throughput (Mbps)',
             legends=legends, subfolders=subfolders, save_file=save_file, show_plot=show_plot)


def plot_dl_transmit_power(base_dir, passo_xticks=5, legends=None, subfolders=None, save_file=True, show_plot=True):
    plot_cdf(base_dir, 'IMT_CDF_of_DL_transmit_power', passo_xticks, xaxis_title='DL Transmit Power (dBm)',
             legends=legends, subfolders=subfolders, save_file=save_file, show_plot=show_plot)


def plot_imt_station_antenna_gain_towards_system(base_dir, passo_xticks=5, legends=None, subfolders=None, save_file=True,
                                                 show_plot=True):
    plot_cdf(base_dir, 'IMT_CDF_of_IMT_station_antenna_gain_towards_system', passo_xticks,
...
def plot_path_loss(base_dir, passo_xticks=5, legends=None, subfolders=None, save_file=True, show_plot=True):
    plot_cdf(base_dir, 'IMT_CDF_of_path_loss', passo_xticks, xaxis_title='Path Loss (dB)',
             legends=legends, subfolders=subfolders, save_file=save_file, show_plot=show_plot)


def plot_ue_antenna_gain_towards_the_bs(base_dir, passo_xticks=5, legends=None, subfolders=None, save_file=True,
                                        show_plot=True):
    plot_cdf(base_dir, 'IMT_CDF_of_UE_antenna_gain_towards_the_BS', passo_xticks, xaxis_title='Antenna Gain (dB)',
             legends=legends, subfolders=subfolders, save_file=save_file, show_plot=show_plot)


def plot_imt_to_system_path_loss(base_dir, passo_xticks=5, legends=None, subfolders=None, save_file=True,
                                 show_plot=True):
    plot_cdf(base_dir, 'SYS_CDF_of_IMT_to_system_path_loss', passo_xticks, xaxis_title='Path Loss (dB)',
             legends=legends, subfolders=subfolders, save_file=save_file, show_plot=show_plot)


def plot_system_antenna_towards_imt_stations(base_dir, passo_xticks=5, legends=None, subfolders=None, save_file=True,
                                             show_plot=True):
    plot_cdf(base_dir, 'SYS_CDF_of_system_antenna_gain_towards_IMT_stations', passo_xticks,
             xaxis_title='Antenna Gain (dB)', legends=legends, subfolders=subfolders, save_file=save_file,
             show_plot=show_plot)


def plot_system_inr(base_dir, passo_xticks=5, legends=None, subfolders=None, save_file=True, show_plot=True):
    plot_cdf(base_dir, 'SYS_CDF_of_system_INR', passo_xticks, xaxis_title='INR (dB)',
             legends=legends, subfolders=subfolders, save_file=save_file, show_plot=show_plot)


def plot_system_interference_power_from_imt_dl(base_dir, passo_xticks=5, legends=None, subfolders=None, save_file=True,
                                               show_plot=True):
    plot_cdf(base_dir, 'SYS_CDF_of_system_interference_power_from_IMT_DL', passo_xticks,
             xaxis_title='Interference Power (dBm/MHz)', legends=legends, subfolders=subfolders, save_file=save_file,
             show_plot=show_plot)


def plot_system_interference_power_from_imt_ul(base_dir, passo_xticks=5, legends=None, subfolders=None, save_file=True,
                                               show_plot=True):
    plot_cdf(base_dir, 'SYS_CDF_of_system_interference_power_from_IMT_UL', passo_xticks,
             xaxis_title='Interference Power (dBm/MHz)', legends=legends, subfolders=subfolders, save_file=save_file,
             show_plot=show_plot)


def plot_system_pfd(base_dir, passo_xticks=5, legends=None, subfolders=None, save_file=True, show_plot=True):
    plot_cdf(base_dir, 'SYS_CDF_of_system_PFD', passo_xticks, xaxis_title='PFD (dBW/m²)',
             legends=legends, subfolders=subfolders, save_file=save_file, show_plot=show_plot)


def plot_inr_samples(base_dir, passo_xticks=5, legends=None, subfolders=None, save_file=True, show_plot=True):
    plot_cdf(base_dir, 'INR_samples', passo_xticks, xaxis_title='INR Samples (dB)',
             legends=legends, subfolders=subfolders, save_file=save_file, show_plot=show_plot)
...
def all_plots(base_dir, legends=None, subfolders=None, save_file=True, show_plot=False):
    ...
    plot_coupling_loss(base_dir, legends=legends, subfolders=subfolders,
                       save_file=save_file, show_plot=show_plot)
    plot_dl_sinr(base_dir, legends=legends, subfolders=subfolders,
                 save_file=save_file, show_plot=show_plot)
    plot_dl_snr(base_dir, legends=legends, subfolders=subfolders,
                save_file=save_file, show_plot=show_plot)
    plot_dl_throughput(base_dir, legends=legends, subfolders=subfolders,
                       save_file=save_file, show_plot=show_plot)
    plot_dl_transmit_power(base_dir, legends=legends,
                           subfolders=subfolders, save_file=save_file, show_plot=show_plot)
    plot_imt_station_antenna_gain_towards_system(
        base_dir, legends=legends, subfolders=subfolders, save_file=save_file, show_plot=show_plot)
    plot_path_loss(base_dir, legends=legends, subfolders=subfolders,
                   save_file=save_file, show_plot=show_plot)
    ...
    plot_system_antenna_towards_imt_stations(
        base_dir, legends=legends, subfolders=subfolders, save_file=save_file, show_plot=show_plot)
    plot_system_inr(base_dir, legends=legends, subfolders=subfolders,
                    save_file=save_file, show_plot=show_plot)
    plot_system_interference_power_from_imt_dl(
        base_dir, legends=legends, subfolders=subfolders, save_file=save_file, show_plot=show_plot)
    plot_system_interference_power_from_imt_ul(
        base_dir, legends=legends, subfolders=subfolders, save_file=save_file, show_plot=show_plot)
    plot_system_pfd(base_dir, legends=legends, subfolders=subfolders,
                    save_file=save_file, show_plot=show_plot)
...
if __name__ == "__main__":
    ...
    all_plots(name, legends=legends, subfolders=subfolders,
