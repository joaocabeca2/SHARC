...
@dataclass
class ParametersWifiEs(ParametersBase):
    """Dataclass containing the Fixed Satellite Services - Earth Station
    parameters for the simulator
    """
    section_name: str = "wifi_es"
    
    # type of wifi-ES location:
    ...
    # Antenna pattern of the wifi Earth station
    ...
    # Parameters for the P.619 propagation model used for sharing studies between IMT-NTN and wifi-ES
    #    space_station_alt_m - altiteude of the IMT-MSS station
    #    earth_station_alt_m - altitude of wifi-ES system (in meters)
    #    earth_station_lat_deg - latitude of wifi-ES system (in degrees)
    #    earth_station_long_diff_deg - difference between longitudes of IMT-NTN station and wifi-ES system
    ...
    # HDwifi propagation parameters
    # HDwifi position relative to building it is on. Possible values are
    ...
    # Enable interference from IMT stations at the same building as the HDwifi
    same_building_enabled: bool = False
    # Enable diffraction loss
    diffraction_enabled: bool = False
    # Building entry loss type applied between BSs and HDwifi ES. Options are:
    ...
    def load_parameters_from_file(self, config_file: str):
        ...
        if self.location not in ["FIXED", "CELL", "NETWORK", "UNIFORM_DIST"]:
            raise ValueError(f"ParameterswifiEs: \
        ...
        if self.polarization.lower() not in ["horizontal", "vertical"]:
            raise ValueError(f"ParameterswifiEss: \
        ...
        if self.channel_model.upper() not in ["FSPL", "TERRESTRIALSIMPLE", "P452", "P619",
                                              "TVRO-URBAN", "TVRO-SUBURBAN", "HDwifi"]:
            raise ValueError(f"ParameterswifiEs: Invalid value for parameter channel_model - {self.channel_model}")
