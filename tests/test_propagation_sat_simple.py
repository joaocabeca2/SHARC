...
class PropagationSatSimpleTest(unittest.TestCase):
    ...
    def setUp(self):
        self.propagation = PropagationSatSimple(random_number_gen=np.random.RandomState(), enable_clutter_loss=False)
    ...
    def test_loss(self):
        ...
        self.assertAlmostEqual(13.19,
                               self.propagation.get_loss(d, f, indoor_stations, elevation),
                               delta = 1e-2)
