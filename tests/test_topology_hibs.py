...
class TopologyHIBSTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.num_clusters = 0 # single BS deployment

    def test_system1(self):

        # Test System 1 - 3 Sectors - single BS deployment
        # Cell Radius 100km
        ...
        self.assertEqual(num_sectors, topology.num_base_stations)

        # check HIBS BS positions - all centered
        self.assertListEqual([0, 0, 0], list(topology.x))
        self.assertListEqual([0, 0, 0], list(topology.y))
        ...
        # check HIBS Area Radius and Intersite Distance
        ...
        # Test System 1 7 Sectors - single BS deployment
        # Cell Radius 100km
        ...
        # check HIBS BS positions - all centered
        self.assertListEqual([0, 0, 0, 0, 0, 0, 0], list(topology.x))
        self.assertListEqual([0, 0, 0, 0, 0, 0, 0], list(topology.y))
        ...
        self.assertAlmostEqual(
            topology.intersite_distance, 155884.57, places=2)
    ...
    def test_system2(self):
        ...
        # check HIBS BS positions - all centered
        self.assertListEqual(19*[0], list(topology.x))
        self.assertListEqual(19*[0], list(topology.y))
        ...
        # check HIBS BS Azimuth and Downtilt
        self.assertListEqual(list(topology.azimuth),
                             [0, 15, 30, 45, 75, 90, 105, 135, 150, 165, 195, 210, 225, 255, 
                              270, 285, 315, 330, 345])
        self.assertListEqual(list(topology.elevation),
