...
#                               delta=.01)
    ...
    def test_simulation_2bs_4ue_fss_es(self):
        ...
        coupling_loss_imt_system = np.array(
            [128.55 - 50 - 10, 128.77 - 50 - 11, 128.93 - 50 - 22, 129.18 - 50 - 23]).reshape((-1, 1))
        npt.assert_allclose(self.simulation.coupling_loss_imt_system,
